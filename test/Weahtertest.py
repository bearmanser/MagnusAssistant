...
def get_lat_lon(place_name):
    ...
    if response.status_code == 200:
        ...
        return f"Error: Unable to fetch coordinates. Status Code: {response.status_code}"
...
def get_weather(latitude, longitude, date=None):
    ...
    if response.status_code == 200:
        ...
        weather = {
            ...
            "weather_description": weather_code_map.get(data["hourly"]["weathercode"][0], "Unknown weather")
        }
        return weather
    else:
